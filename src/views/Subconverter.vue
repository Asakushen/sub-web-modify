  ...
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "浅草随机加密后端【vless reality+hy1+hy2】": "https://psub.waku.cf",
          "⬇️⬇️以下均备用、无加密⬇️⬇️": "https://psub2.waku.cf",
          "肥羊增强型后端【vless reality+hy1+hy2】": "https://url.v1.mk",
          "品云": "https://sub.id9.cc",
          "subconverter作者提供: ": "https://sub.xeton.dev",
          "边缘": "https://pub-api-1.bianyuan.xyz",
          "熊猫": "https://sub.maoxiongnet.com",
        },
        backendOptions: [
          {value: "https://psub.waku.cf"},
      ...
      form: {
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "https://psub.waku.cf" : this.getUrlParam(),
...
tanchuang() {
  this.$alert(`<div style="text-align:center;font-size:15px">
    <strong><span style="font-size:20px;color:red">全新订阅转换方案，彻底杜绝盗用风险！</span></strong></br>
    <strong><span style="font-size:20px">采用CF Worker随机加密技术，动态混淆域名、UUID、密码，</span></strong></br>
    <strong><span style="font-size:20px;color:blue">实现节点信息深度加密，安全性拉满，让你的订阅真正独享！</span></strong></br></br>

    <strong><span style="font-size:20px">最美观的订阅转换工具：</span></strong></br>
